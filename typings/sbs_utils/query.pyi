...
def closest (self, the_set, max_dist=None, filter_func=None) -> sbs_utils.engineobject.CloseData:
    ...
def closest_list (source: int | sbs_utils.engineobject.CloseData | sbs_utils.engineobject.SpawnData | sbs_utils.spaceobject.SpaceObject, the_set, max_dist=None, filter_func=None) -> list[sbs_utils.engineobject.CloseData]:
    ...
