...
MastGlobals.import_python_module('sbs_utils.procedural.messages')
...
MastGlobals.import_python_module('sbs_utils.procedural.hail')
...
MastGlobals.import_python_module('sbs_utils.procedural.amd_theater')
MastGlobals.import_python_module('sbs_utils.procedural.races')
MastGlobals.import_python_module('sbs_utils.procedural.player_roster')
...
MastGlobals.import_python_module('sbs_utils.procedural.away')
