...
# The compact tail that replaces the engine waterfall in a console's layout: JUST THE
# LATEST MESSAGE. It is a headline, not a log - the history lives one tab away, and a
# console has better uses for the space than a second copy of it. Callers that want more
# pass a count.
LOG_TAIL_LINES = 1
