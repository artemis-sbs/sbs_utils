...
| `sbs soak run <mission> <scenario>` | **Conformance soak** - unattended, with a real exit code; `--engine` for the real engine, plus [`--clients N` / `--consoles`](testing.md#bringing-consoles-along) to bring real consoles along |
